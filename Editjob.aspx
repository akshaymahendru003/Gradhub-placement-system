<%@ Page Title="" Language="C#" MasterPageFile="~/member.master" AutoEventWireup="true" CodeFile="Editjob.aspx.cs" Inherits="Editjob" %>
              ...
              GridLines="Vertical" Width="1040px" CellPadding="10">
                ...
                <Columns>
                    ...
                    <asp:HyperLinkField DataNavigateUrlFields="jobid" 
                        DataNavigateUrlFormatString="updatejob.aspx?jobid={0}" 
                        HeaderText="Update" Text="Update" />
                    <asp:HyperLinkField DataNavigateUrlFields="jobid" 
                        DataNavigateUrlFormatString="deletejob.aspx?jobid={0}" 
