<%@ Page Title="" Language="C#" MasterPageFile="~/user.master" AutoEventWireup="true" CodeFile="companysignup.aspx.cs" Inherits="companysignup" %>
          ...
          <div class="col-lg-12">
           ...
           <div class="form-group">
              ...
              <div class="form-group">
                 About Company
                  <br />
                <asp:TextBox ID="TextBox9" runat="server" class="form-control txt" placeholder="Company Description" TextMode="MultiLine" required></asp:TextBox>
              </div>
              <div class="form-group">
                 Company Logo
                  <br />
                <asp:FileUpload ID="FileUpload1" runat="server" required></asp:FileUpload>
              </div>
              <div class="form-group">
                 Login Username
                <asp:TextBox ID="TextBox7" runat="server" class="form-control txt" placeholder="Username" required></asp:TextBox>
              </div>
              <div class="form-group">
                 Login Password
                <asp:TextBox ID="TextBox8" runat="server" class="form-control txt" placeholder="Password" TextMode="Password" required></asp:TextBox>
              </div>
              <div class="col-4">
