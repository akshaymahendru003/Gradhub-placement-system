...
public partial class resumedetails : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string q1 = "select resume,personal_details.name,email,phoneno,aphoneno,state.name as sname,city.name as cname,address,about,objective,pic,resume from personal_details,state,city where uname=@un and cityid=city and stateid=personal_details.state";
        ...
        if (res1.HasRows == true)
        {
            ...
            HyperLink1.NavigateUrl = "uploads/" + res1["resume"];
        }
    }
    protected void Button1_Click(object sender, EventArgs e)
    {
        Response.Redirect("sendmessage.aspx?uname="+Request["uname"]+"&applyfor="+Request["jobid"]);
    }
}