...
public partial class chnageemppass : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        if (TextBox2.Text == TextBox3.Text)
        {
            ...
            String q1 = "select * from signup where email=@em and password=@pass";
            ...
            if (res1.HasRows == true)
            {
                myconn.Close();
                myconn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
                String q2 = "update signup set password=@pass where email=@em and password=@cpass";
