...
public partial class viewresumead : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string q1 = "select personal_details.name,email,resume,phoneno,aphoneno,state.name as sname,city.name as cname,address,about,objective,pic,resume from personal_details,state,city where uname=@un and cityid=city and stateid=personal_details.state";
