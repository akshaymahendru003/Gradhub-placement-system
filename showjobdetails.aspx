<%@ Page Title="" Language="C#" MasterPageFile="~/employee.master" AutoEventWireup="true" CodeFile="showjobdetails.aspx.cs" Inherits="showjobdetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <section class="site-section">
      <div class="container">
        ...
        <div class="col-2">
       <asp:Button ID="Button2" runat="server" Text="Apply For Job" 
