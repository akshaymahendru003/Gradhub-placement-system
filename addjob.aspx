<%@ Page Title="" Language="C#" MasterPageFile="~/member.master" AutoEventWireup="true" CodeFile="addjob.aspx.cs" Inherits="addjob" %>
        ...
        <div class="row">
          <div class="col-md-7">
            ...
            <div class="custom-breadcrumbs">
              <a href="#">Company Panel</a> <span class="mx-2 slash">/</span><span class="text-white"><strong>Post Job</strong></span></div>
          </div>
        </div>
      </div>
    </section>
           ...
           <div class="form-group">
              ...
              <div class="form-group">
                ...
                <asp:TextBox ID="TextBox9" runat="server" class="form-control txt" 
                      placeholder="About Job" TextMode="MultiLine" Height="150px" required></asp:TextBox>
              </div>
              <div class="form-group">
                 Requirments
                  <br />
                <asp:TextBox ID="TextBox5" runat="server" class="form-control txt" 
                      placeholder="Requirements" TextMode="MultiLine" Height="150px" required></asp:TextBox>
              </div>
              <div class="form-group">
                 Expected Salary
                 <asp:TextBox ID="TextBox7" runat="server" class="form-control txt" 
                      placeholder="Expected Salary" required></asp:TextBox>
              </div>
              <div class="col-4">
