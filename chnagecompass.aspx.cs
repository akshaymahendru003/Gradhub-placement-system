...
public partial class chnagecompass : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        if (TextBox2.Text == TextBox3.Text)
        {
            ...
            String q1 = "select * from company where username=@em and password=@pass";
            ...
            if (res1.HasRows == true)
            {
                myconn.Close();
                myconn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
                String q2 = "update company set password=@pass where username=@em and password=@cpass";
