<%@ Page Title="" Language="C#" MasterPageFile="~/user.master" AutoEventWireup="true" CodeFile="viewcompanydetails.aspx.cs" Inherits="viewcompanydetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <section class="site-section">
      ...
      <div class="row">
      <div class="col-lg-1"></div>
      <div class="col-lg-10">To view and Apply for Job Please <a href="login.aspx">Login</a></div>
