<%@ Page Title="" Language="C#" MasterPageFile="~/member.master" AutoEventWireup="true" CodeFile="resumedetails.aspx.cs" Inherits="resumedetails" %>
 ...
 <section class="section-hero overlay inner-page bg-image" style="background-image: url('images/hero_1.jpg');" id="home-section">
    ...
    <div class="row">
        ...
        <div class="custom-breadcrumbs">
            <a href="#">User</a> <span class="mx-2 slash">/</span><span class="text-white"><strong>Resume</strong></span></div>
        </div>
    </div>
    </div>
</section>
           ...
           <figure class="mb-5">
            ...
            <div class="col-lg-8"><h3 class="h5 d-flex align-items-center mb-4 text-primary">About</h3>
              ...
              <p align="justify"><asp:Label ID="Label1" runat="server" Text="Label" class="t"></asp:Label></p>
                ...
                <asp:HyperLink ID="HyperLink1" runat="server">Download Resume</asp:HyperLink>
            ...
            <div class="col-lg-6"><div class="bg-light p-3 border rounded mb-4">
              ...
              <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT qualification.name, qualification.percentage, classes.name AS Expr1 FROM qualification INNER JOIN classes ON qualification.classid = classes.id AND qualification.uname = @uname">
                    <SelectParameters>
           ...
           <div class="col-lg-6">
            <div class="bg-light p-3 border rounded mb-4">
                ...
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                    ...
                    SelectCommand="SELECT id, cname, phone, state, city, address, experience, uname FROM experience WHERE (uname = @uname)">
                    <SelectParameters>
