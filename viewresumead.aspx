<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="viewresumead.aspx.cs" Inherits="viewresumead" %>
            ...
            <div class="col-lg-6"><div class="bg-light p-3 border rounded mb-4">
              ...
              <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT qualification.name, qualification.percentage, classes.name AS Expr1 FROM qualification INNER JOIN classes ON qualification.classid = classes.id WHERE (qualification.uname = @uname)">
                    <SelectParameters>
