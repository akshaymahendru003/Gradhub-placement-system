<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="viewcompany.aspx.cs" Inherits="viewcompany" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <section class="section-hero overlay inner-page bg-image" style="background-image: url('images/hero_1.jpg');" id="home-section">
      <div class="container">
        <div class="row">
          <div class="col-md-7">
            <h1 class="text-white font-weight-bold">View Companies</h1>
            <div class="custom-breadcrumbs">
              <a href="#">Admin</a> <span class="mx-2 slash">/</span>
              
              <span class="text-white"><strong>View Confirmed Companies</strong></span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row mb-5 justify-content-center">
          <div class="col-md-12 text-center">
            <h2 class="section-title mb-2">View Confirmed Companies</h2>
          </div>
        </div>
              ...
              GridLines="Vertical" Width="900px" CellPadding="10">
                ...
                <Columns>
                    ...
                    <asp:HyperLinkField DataNavigateUrlFields="username" 
                        DataNavigateUrlFormatString="companydetails.aspx?uname={0}&amp;st=confirm" 
                        HeaderText="More Details" Text="More Details" />
                    <asp:HyperLinkField DataNavigateUrlFields="username" 
                        DataNavigateUrlFormatString="deletecompany.aspx?uname={0}" HeaderText="Delete" 
                        Text="Delete" />
                </Columns>
